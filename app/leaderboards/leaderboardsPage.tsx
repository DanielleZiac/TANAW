...
const Leaderboards: React.FC = () => {
  return (
    <div className="min-h-screen mt-20 ml-32 flex flex-col items-center bg-transparent py-6 px-8">
      ...
      {/* Top 3 Section */}
        <div className="flex justify-center gap-4 mb-8 w-full max-w-3xl">
            {leaderboardData.slice(0, 3).map((entry, index) => (
                <div
                key={entry.rank}
                className={`${getButtonStyles(false).className} flex flex-col items-center bg-white shadow-lg rounded-lg p-4 relative flex-shrink-0`}
                style={{
