  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="fixed right-4 top-[100px] lg:right-10 lg:top-[115px] z-50 rounded-full bg-white  p-2"
      >
        <svg
          ...
          viewBox="0 0 30 30"
          fill="none"
          className="text-cBlue lg:w-8 lg:h-8"
        >
          <path
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="fixed right-4 top-[125px] lg:right-10 lg:top-[147px] z-40 bg-white shadow-lg py-4 px-2 rounded-b-full flex flex-col items-center space-y-3">
          {/* Institution Link */}
          <a
    ...
    />
          ...
          <a
            ...
            className="flex flex-col items-center text-gray-300 hover:text-blue-500 lg:w-8 lg:h-8"
          >
            <svg
    xmlns="http://www.w3.org/2000/svg"
    width="25"
  ...
  >
    ...
    />
          ...
          <a
            ...
            className="flex flex-col items-center text-gray-300 hover:text-blue-500"
          >
            <GoTrophy className="text-cBlue text-xl lg:w-8 lg:h-8" />
