...
const FloatingDropdown: React.FC = () => {
  ...
  className="fixed right-[3%] top-[110px] rounded-full bg-white p-2 z-50"
>
  <svg
  ...
  >
    ...
    />
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="fixed right-[3%] top-[140px] z-5 bg-white shadow-lg py-4 px-2 rounded-b-full flex flex-col items-center space-y-3">
