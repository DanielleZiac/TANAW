...
import SDGlink1 from '../explore/sdglink/SDGlink1.jpg';
import SDGlink2 from '../explore/sdglink/SDGlink2.jpg';
import SDGlink3 from '../explore/sdglink/SDGlink3.jpg';
...
import SDGlink7 from '../explore/sdglink/SDGlink7.jpg';
import SDGlink8 from '../explore/sdglink/SDGlink8.jpg';
import SDGlink9 from '../explore/sdglink/SDGlink9.jpg';
import SDGlink10 from '../explore/sdglink/SDGlink10.jpg';
import SDGlink11 from '../explore/sdglink/SDGlink11.jpg';
import SDGlink12 from '../explore/sdglink/SDGlink12.jpg';
import SDGlink13 from '../explore/sdglink/SDGlink13.jpg';
import SDGlink14 from '../explore/sdglink/SDGlink14.jpg';
import SDGlink15 from '../explore/sdglink/SDGlink15.jpg';
import SDGlink16 from '../explore/sdglink/SDGlink16.jpg';
import SDGlink17 from '../explore/sdglink/SDGlink17.jpg';
      ...
      <div className="flex flex-col justify-start md:w-1/2 sm:w-full">
        ...
        <div>
          <img
            src={Logo.src} 
            alt="Logo"
            className="object-cover rounded-lg -m-16 pl-20"
          />
        </div>

        {/* United Nations Section */}
        <section className="-mt-4">
          <h2 className="text-2xl font-semibold mb-2">TOP 3 LIKED INSTITUTI ONS</h2>
          <hr className="border-black mb-4 w-3/5" />
          <div className="grid grid-cols-3 gap-4 px-8 -ml-8" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))' }}>
            {/* Top 3 Liked Institutions with Transparent Background and Text */}
            {[SDGlink1, SDGlink2, SDGlink3].map((image, index) => (
                <div
                key={index}
